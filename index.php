...
<body>
    <div class="container">
        ...
        <p>PHP dapat disisipkan langsung ke dalam kode HTML menggunakan tanda `<?` dan `?>`. Ini memungkinkan Anda untuk membuat halaman web dinamis dengan menambahkan logika PHP ke dalam kode HTML.</p>
